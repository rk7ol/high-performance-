...
//填充二维数组
extern arr_cube *fill_arr_of_cube(int x,int y,int z,int myrank,int cube_numb_of_pro,struct cube *** temp);
...
//通信
extern void communication(int allrank,int myrank,int cube_numb_of_pro,struct send_table_element *send_arr,process_send_num *con_arr,MPI_Datatype MPI_send_element, HashMap* index_temp_table);
#endif //_TEST_H